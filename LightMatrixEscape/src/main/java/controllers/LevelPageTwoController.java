...
public class LevelPageTwoController {
    ...
    public void initialize() throws FileNotFoundException, IOException {
        ...
        if (newPlayer != null) {
            usernameText.setText(newPlayer.getUsername());
        }
...
//                        System.out.println("YYes");
                    ...
                    if (isRefTouchingTheWallTwo) {
                        ...
                        //determine Final reflect ray with wall
                        double[] startPofFSecReflRay = lineMethod.getTheStartPointOfLine(secReflectRay);
                        double[] endPofSecReflRay = lineMethod.getTheEndPointOfLine(secReflectRay);

                        boolean secReflectRayIsTouchingTheWallTwo = wallMethod.wallTouched(startPofFSecReflRay,
                                endPofSecReflRay, wallTwo);
                        boolean secReflectRayIsTouchingTheWallThree = wallMethod.wallTouched(startPofFSecReflRay,
                                endPofSecReflRay, wallThree);

                        if (secReflectRayIsTouchingTheWallTwo) {
                            double[] intersectionRayWithWallTwo = wallMethod.findIntersectionWithWall(startPofFSecReflRay,
                                    endPofSecReflRay, wallTwo);
                            //Set ReflectRay proporties
                            secReflectRay.setEndX(intersectionRayWithWallTwo[0]);
                            secReflectRay.setEndY(intersectionRayWithWallTwo[1]);
                        }

                        if (secReflectRayIsTouchingTheWallThree) {
                            double[] intersectionRayWithWallThree = wallMethod.findIntersectionWithWall(startPofFSecReflRay,
                                    endPofSecReflRay, wallThree);
                            //Set ReflectRay proporties
                            secReflectRay.setEndX(intersectionRayWithWallThree[0]);
                            secReflectRay.setEndY(intersectionRayWithWallThree[1]);
                        }
                    }
                }
